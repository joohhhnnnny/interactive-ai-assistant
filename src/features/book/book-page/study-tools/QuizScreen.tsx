...
export function QuizScreen({
  ...
  const runQuizGeneration = useCallback(async () => {
    ...
    try {
      const answer = await offlineAi.generateStudyTool('quiz', 'mcq', itemCount);
  ...
  }, [book.title, itemCount, offlineAi]);
        ...
        <View style={styles.toolControls}>
          ...
          >
            <Text style={styles.generateButtonText}>
              {isGenerating || isWaitingForHelper ? 'Generating...' : 'Generate quiz'}
            </Text>
          </Pressable>
        </View>
        ...
        <View style={styles.scoreModalOverlay}>
          <View style={styles.scoreModalCard}>
            ...
            <View style={styles.scoreModalActions}>
              ...
              >
                <Text style={styles.quizActionSecondaryText}>Back to quiz</Text>
              </Pressable>
            </View>
          </View>
        </View>
